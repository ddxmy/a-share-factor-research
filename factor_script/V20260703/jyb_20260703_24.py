...
# ---- 因子元信息 ----
FACTOR_NAME = 'jyb_20260703_24'
FACTOR_TYPE = 'T-1_factor'
FORMULA = 'Cs_ZScore(Ts_DecayExp(Ts_Correlation(Ts_Return(close, 1), turn, 20), 10))'

def factor_jyb_20260703_24(start_date, end_date, md_data_file, return_fillna_dic=False):
    """收益与换手20日协动性的10日衰减加权截面Z-Score
    ...
    Returns:
        pd.DataFrame: 包含因子列 'jyb_20260703_24' 的 DataFrame，index 为 (dt, Ticker)
    """
    ...
    # 1日收益率与换手率的20日相关 → 10日衰减加权
    ret_1d = close_panel.pct_change(1)
    corr = ret_1d.rolling(20, min_periods=1).corr(turn_panel)
    decayed = corr.ewm(alpha=0.1, min_periods=1).mean()
...
if __name__ == '__main__':
    ...
    factor_df = factor_jyb_20260703_24(

...
# ---- 因子元信息 ----
FACTOR_NAME = 'jyb_20260703_38'
FACTOR_TYPE = 'T-1_factor'
FORMULA = 'Cs_Percentile(Div(close, Sub(Ts_Quantile(close, 20, 0.75), Ts_Quantile(close, 20, 0.25))))'

def factor_jyb_20260703_38(start_date, end_date, md_data_file, return_fillna_dic=False):
    """收盘价/20日四分位距比值的截面百分位（价格在区间中的位置）
    ...
    Returns:
        pd.DataFrame: 包含因子列 'jyb_20260703_38' 的 DataFrame，index 为 (dt, Ticker)
    """
    ...
    # close / 20日四分位距
    iqr = close_panel.rolling(20, min_periods=1).quantile(0.75) - close_panel.rolling(20, min_periods=1).quantile(0.25)
    ratio = close_panel / (iqr + 1e-12)
...
if __name__ == '__main__':
    ...
    factor_df = factor_jyb_20260703_38(

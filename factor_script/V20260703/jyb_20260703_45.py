...
# ---- 因子元信息 ----
FACTOR_NAME = 'jyb_20260703_45'
FACTOR_TYPE = 'T-1_factor'
FORMULA = 'Cs_Percentile(Div(close, Ts_Quantile(high, 20, 0.75)))'

def factor_jyb_20260703_45(start_date, end_date, md_data_file, return_fillna_dic=False):
    """收盘价/20日75分位高点的比值截面百分位（高位接近度）
    ...
    Returns:
        pd.DataFrame: 包含因子列 'jyb_20260703_45' 的 DataFrame，index 为 (dt, Ticker)
    """
    ...
    # close / 20日high的75分位
    high_q75 = high_panel.rolling(20, min_periods=1).quantile(0.75)
    ratio = close_panel / (high_q75 + 1e-12)
...
if __name__ == '__main__':
    ...
    factor_df = factor_jyb_20260703_45(

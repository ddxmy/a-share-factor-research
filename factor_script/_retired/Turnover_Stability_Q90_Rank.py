...
# ---- 因子元信息 ----
FACTOR_NAME = 'Turnover_Stability_Q90_Rank'
FACTOR_TYPE = 'T-1_factor'

_fill_cache: dict = {}


def factor_Turnover_Stability_Q90_Rank(start_date, end_date, md_data_file, return_fillna_dic=False):
    """过去20日换手率标准差的倒数除以过去20日换手率90分位数的截面排名

    复现公式: Cs_Rank(Div(Inverse(Ts_Std(turn, 20)), Ts_Quantile(turn, 20, 0.90)))
    复现分数: 58.78
    """
    ...
    quantile_90 = turn_panel.rolling(20, min_periods=1).quantile(0.90)
    # Div(Inverse(std_20), quantile_90) = (1/std) / quantile
    result = (1.0 / std_20) / quantile_90
    # Cs_Rank
...
if __name__ == '__main__':
    ...
    factor_df = factor_Turnover_Stability_Q90_Rank(

...
Formula:
    Ts_EMA(Div(Sub(high, low), close), 10)
"""
import os
import sys
...
FACTOR_NAME = 'Smoothed_Intraday_Range'
FACTOR_TYPE = "T-1_factor"
FORMULA = 'Ts_EMA(Div(Sub(high, low), close), 10)'
...
def factor_4_Smoothed_Intraday_Range(start_date, end_date, md_data_file, return_fillna_dic=False):
...
if __name__ == "__main__":
    ...
    factor_df = factor_4_Smoothed_Intraday_Range(start_date, end_date, md_data_file)

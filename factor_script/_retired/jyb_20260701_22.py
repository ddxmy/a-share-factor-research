...
def factor_jyb_20260701_22(start_date, end_date, md_data_file, return_fillna_dic=False):
    """涨跌幅与换手率乘积的截面5%-95%缩尾处理

    复现公式: Cs_Winsorize(Mul(Ts_Return(close, 1), turn), 0.05, 0.95)
    原始分数: 58.78
    ...
    Returns:
        pd.DataFrame: 包含因子列 'jyb_20260701_22' 的 DataFrame，index 为 (dt, Ticker)
    """
    ...
    result_panel = executor.compute("Cs_Winsorize(Mul(Ts_Return(close, 1), turn), 0.05, 0.95)")
...
if __name__ == '__main__':
    ...
    factor_df = factor_jyb_20260701_22(

...
# ---- 因子元信息 ----
FACTOR_NAME = 'Turnover_Stability_Median_Rank'
FACTOR_TYPE = 'T-1_factor'

_fill_cache: dict = {}


def factor_Turnover_Stability_Median_Rank(start_date, end_date, md_data_file, return_fillna_dic=False):
    """过去20日换手率标准差的倒数除以过去20日换手率中位数的截面排名

    复现公式: Cs_Rank(Div(Inverse(Ts_Std(turn, 20)), Ts_Median(turn, 20)))
    复现分数: 59.06
    """
    ...
    # Div(Inverse(std_20), median_20) = (1/std) / median
    result = (1.0 / std_20) / median_20
    # Cs_Rank
...
if __name__ == '__main__':
    ...
    factor_df = factor_Turnover_Stability_Median_Rank(

...
def factor_jyb_20260701_37(start_date, end_date, md_data_file, return_fillna_dic=False):
    """5日均值的日收益率平方（5日已实现方差

    复现公式: Ts_Mean(Power(Ts_Return(close, 1), 2), 5)
    原始分数: 35.0
    ...
    Returns:
        pd.DataFrame: 包含因子列 'jyb_20260701_37' 的 DataFrame，index 为 (dt, Ticker)
    """
    ...
    result_panel = executor.compute("Ts_Mean(Power(Ts_Return(close, 1), 2), 5)")
...
if __name__ == '__main__':
    ...
    factor_df = factor_jyb_20260701_37(

...
def factor_jyb_20260701_38(start_date, end_date, md_data_file, return_fillna_dic=False):
    """20日收盘价/VWAP方差的0.5次方带符号幂的截面排名

    复现公式: Cs_Rank(SignedPower(Ts_Var(Div(close, vwap), 20), 0.5))
    原始分数: 53.06
    ...
    Returns:
        pd.DataFrame: 包含因子列 'jyb_20260701_38' 的 DataFrame，index 为 (dt, Ticker)
    """
    ...
    result_panel = executor.compute("Cs_Rank(SignedPower(Ts_Var(Div(close, vwap), 20), 0.5))")
...
if __name__ == '__main__':
    ...
    factor_df = factor_jyb_20260701_38(

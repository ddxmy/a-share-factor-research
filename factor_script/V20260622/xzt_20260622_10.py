...
# ---- 因子元信息 ----
FACTOR_NAME = 'xzt_20260622_10'
FACTOR_TYPE = 'T-1_factor'
FORMULA = 'Cs_Rank(Ts_Mean(Abs(Div(Sub(close,vwap),vwap)), 10))'

def factor_xzt_20260622_10(start_date, end_date, md_data_file, return_fillna_dic=False):
    """过去10日收盘价相对VWAP的绝对偏离幅度的平均值，在全市场中的排名
    ...
    # 10日均值
    mean_10 = abs_dev_pct.unstack().rolling(10, min_periods=1).mean()
    # Cs_Rank
    factor_df = pd.DataFrame()
    factor_df[FACTOR_NAME] = mean_10.rank(axis=1, pct=True).stack()
    return factor_df
...
if __name__ == '__main__':
    ...
    factor_df = factor_xzt_20260622_10(

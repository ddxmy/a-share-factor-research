...
# ---- 因子元信息 ----
FACTOR_NAME = 'jyb_20260701_23'
FACTOR_TYPE = 'T-1_factor'
FORMULA = 'Div(vwap, Sub(Ts_Max(high, 10), Ts_Min(low, 10)))'

def factor_jyb_20260701_23(start_date, end_date, md_data_file, return_fillna_dic=False):
    """VWAP除以10日价格振幅（10日最高-10日最低）
    ...
    Returns:
        pd.DataFrame: 包含因子列 'jyb_20260701_23' 的 DataFrame，index 为 (dt, Ticker)
    """
    ...
    # 10日价格振幅: 10日最高 - 10日最低
    price_range = high_panel.rolling(10, min_periods=1).max() - low_panel.rolling(10, min_periods=1).min()

    # vwap / 振幅
    factor_val = vwap_panel / (price_range + 1e-12)
...
if __name__ == '__main__':
    ...
    factor_df = factor_jyb_20260701_23(

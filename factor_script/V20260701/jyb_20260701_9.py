...
# ---- 因子元信息 ----
FACTOR_NAME = 'jyb_20260701_9'
FACTOR_TYPE = 'T-1_factor'
FORMULA = 'Cs_Percentile(Div(close, Ts_Quantile(high, 20, 0.9)))'

def factor_jyb_20260701_9(start_date, end_date, md_data_file, return_fillna_dic=False):
    """收盘价与20日最高价90%分位数之比的截面百分位
    ...
    Returns:
        pd.DataFrame: 包含因子列 'jyb_20260701_9' 的 DataFrame，index 为 (dt, Ticker)
    """
    ...
    price_ratio = close_panel / (high_q90 + 1e-12)
...
if __name__ == '__main__':
    ...
    factor_df = factor_jyb_20260701_9(

...
# ---- 因子元信息 ----
FACTOR_NAME = 'jyb_20260701_31'
FACTOR_TYPE = 'T-1_factor'
FORMULA = 'Ts_EMA(Abs(Ts_Covariance(Ts_Return(close, 1), turn, 20)), 15)'

def factor_jyb_20260701_31(start_date, end_date, md_data_file, return_fillna_dic=False):
    """15日EMA加权的20日收益率与换手率协方差的绝对值
    ...
    Returns:
        pd.DataFrame: 包含因子列 'jyb_20260701_31' 的 DataFrame，index 为 (dt, Ticker)
    """
    ...
    # 1日收益率与换手率的20日协方差 → 取绝对值
    ret_1d = close_panel.pct_change(1)
    abs_cov = ret_1d.rolling(20, min_periods=1).cov(turn_panel).abs()

    # Ts_EMA(..., 15): 15日EMA
    factor_val = abs_cov.ewm(span=15).mean()
...
if __name__ == '__main__':
    ...
    factor_df = factor_jyb_20260701_31(

...
# ---- 因子元信息 ----
FACTOR_NAME = 'jyb_20260701_16'
FACTOR_TYPE = 'T-1_factor'
FORMULA = 'SignedPower(Div(Sub(BBands_Upper(close, 20, 2), BBands_Lower(close, 20, 2)), close), 0.5)'

def factor_jyb_20260701_16(start_date, end_date, md_data_file, return_fillna_dic=False):
    """布林带宽度（上下轨之差）与收盘价之比的0.5次方带符号幂
    ...
    Returns:
        pd.DataFrame: 包含因子列 'jyb_20260701_16' 的 DataFrame，index 为 (dt, Ticker)
    """
    ...
    # 带宽 / close → 0.5次方带符号幂
    width_ratio = bb_width / (close_panel + 1e-12)
    factor_val = np.sign(width_ratio) * np.abs(width_ratio) ** 0.5
...
if __name__ == '__main__':
    ...
    factor_df = factor_jyb_20260701_16(
